import { TestVector } from "./test-vector";
  ...
  export const bip32Vector1: TestVector = {
  ...
  const bip32Vector4: TestVector = {
    ...
    chains: {
      m: {
        ...
        privKey: 'xprv9s21ZrQH143K48vGoLGRPxgo2JNkJ3J3fqkirQC2zVdk5Dgd5w14S7fRDyHH4dWNHUgkvsvNDCkvAwcSHNAQwhwgNMgZhLtQC63zxwhQmRv',
      },
      "m/0'": {
  ...
  const bip32Vectors = [bip32Vector1, bip32Vector2, bip32Vector3, bip32Vector4];
  export default bip32Vectors;